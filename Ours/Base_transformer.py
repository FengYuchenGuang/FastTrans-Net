...
class ASP_BAT(nn.Module):
    def __init__(
        ...
        super(ASP_BAT, self).__init__()

        self.num_classes = num_classes
        self.point_pred = point_pred
        self.transformer_type = "ASP_BATransformer" if transformer_type_index == 0 else "Transformer"
    ...
    def forward(self, x):
        ...
        if self.transformer_type == 'ASP_BATransformer':
        ...
        print("latent_tensor", latent_tensor.shape)
        # shape:(bs, 1 , 128)
        ...
        print('trans_feature_maps',trans_feature_maps.shape)
